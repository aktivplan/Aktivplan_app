...
class DailyActivitiesHomeWidget : GlanceAppWidget() {
  ...
  companion object {
    ...
    private const val IMAGE_URL = "dailyActivitiesImageUrl"
    private const val IMAGE_PATH = "dailyActivitiesImagePath"
  }
