          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.max,
                children: [
                  SelectableText(context.i18n.ratingValue_0_1, style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: lightTextColor)),
                  Spacer(),
                  SelectableText(context.i18n.ratingValue_10, style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: lightTextColor)),
                ],
              ),
              SizedBox(
                height: 35,
