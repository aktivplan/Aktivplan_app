...
abstract class AppLocalizations {
  ...
  /// No description provided for @activityPlanStep2Task.
  ///
  /// In de, this message translates to:
  /// **'Aufgabe anpassen'**
  String get activityPlanStep2Task;
  ...
  /// No description provided for @activityPlanStep3Task.
  ///
  /// In de, this message translates to:
  /// **'Aufgabe planen'**
  String get activityPlanStep3Task;
  ...
  /// No description provided for @durationValuePointsShort.
  ///
  /// In de, this message translates to:
  /// **'Pkt.'**
  String get durationValuePointsShort;
  ...
  /// No description provided for @importPatientsFromCsv.
  ///
  /// In de, this message translates to:
  /// **'Patienten aus CSV importieren'**
  String get importPatientsFromCsv;

  /// No description provided for @importSummaryCreated.
  ///
  /// In de, this message translates to:
  /// **'Erstellt: {count}'**
  String importSummaryCreated(int count);

  /// No description provided for @importSummaryUpdated.
  ///
  /// In de, this message translates to:
  /// **'Aktualisiert: {count}'**
  String importSummaryUpdated(int count);

  /// No description provided for @importSummarySkipped.
  ///
  /// In de, this message translates to:
  /// **'Übersprungen: {count}'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Keine Empfehlungen für die aktuelle Woche.'**
  ...
  ///
  /// In de, this message translates to:
  /// **'Wie empfindest du die Temperatur für dich?'**
  ...
  /// No description provided for @recommendationMoveActivity.
  ///
  /// In de, this message translates to:
  /// **'Aktivität verschieben'**
  String get recommendationMoveActivity;

  /// No description provided for @recommendationMoveActivityRoute.
  ///
  /// In de, this message translates to:
  /// **'Routenempfehlung'**
  String get recommendationMoveActivityRoute;

  /// No description provided for @recommendationMoveActivityToRoute.
  ///
  /// In de, this message translates to:
  /// **'Aktivität {name} wird von {startLocation} nach {endLocation} verschoben.'**
  String recommendationMoveActivityToRoute(
      String name, String startLocation, String endLocation);

  /// No description provided for @recommendationMoveActivityToTime.
  ///
  /// In de, this message translates to:
  /// **'Aktivität {name} wird auf {time} Uhr verschoben.'**
  String recommendationMoveActivityToTime(String name, String time);

  /// No description provided for @recommendationReason_ACTIVE_MOBILITY_UNFEASIBLE.
  ///
  /// In de, this message translates to:
  /// **'Aktivität nicht ausführbar'**
  String get recommendationReason_ACTIVE_MOBILITY_UNFEASIBLE;

  /// No description provided for @recommendationReason_ACTIVITY_LEVEL.
  ///
  /// In de, this message translates to:
  /// **'Aktivitätslevel'**
  String get recommendationReason_ACTIVITY_LEVEL;

  /// No description provided for @recommendationReason_ADDITIONAL_OPPORTUNITY.
  ///
  /// In de, this message translates to:
  /// **'Zusätzliche Aktivität'**
  String get recommendationReason_ADDITIONAL_OPPORTUNITY;

  /// No description provided for @recommendationReason_HEAT.
  ///
  /// In de, this message translates to:
  /// **'Hitze'**
  String get recommendationReason_HEAT;

  /// No description provided for @recommendationReason_PRECIPITATION.
  ///
  /// In de, this message translates to:
  /// **'Niederschlag'**
  String get recommendationReason_PRECIPITATION;

  /// No description provided for @recommendationReason_SEVERE_WEATHER.
  ///
  /// In de, this message translates to:
  /// **'Schlechtes Wetter'**
  String get recommendationReason_SEVERE_WEATHER;
  ...
  /// No description provided for @recommendationWarningDay.
  ///
  /// In de, this message translates to:
  /// **'{warning} für {date}'**
  String recommendationWarningDay(String warning, String date);

  /// No description provided for @recommendationWarningDays.
  ///
  /// In de, this message translates to:
  /// **'{warning} von {startDate} bis {endDate}'**
  ...
  /// No description provided for @waitTimeAfterExerciseSeconds.
  ///
  /// In de, this message translates to:
  /// **'Wartezeit nach Übung (Sekunden)'**
  String get waitTimeAfterExerciseSeconds;

  /// No description provided for @waitTimeText.
  ///
  /// In de, this message translates to:
  /// **'Zusatztext Wartezeit'**
