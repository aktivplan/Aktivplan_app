...
class EnduranceExercisesTable extends StatefulWidget {
  final List<EnduranceExercise> fetchedExercises;
  final Function editExercise;

  EnduranceExercisesTable({
    Key? key,
  ...
  @override
  _EnduranceExercisesTableState createState() => _EnduranceExercisesTableState();
}

class _EnduranceExercisesTableState extends State<EnduranceExercisesTable> {
                        ...
                        if (!size.isMobile)
                          DataCell(
                            Container(
                              ...
                              child: Text(
                                "${Duration(seconds: exercise.exerciseDurationSeconds ?? 0).inMinutes} ${context.i18n.durationValueMinutes}",
                                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                      letterSpacing: 1.1,
                                    ),
                              ),
