...
class UserControllerApi {
  ...
  /// Parameters:
  ///
  /// * [String] institutionId (required):
  ///
  /// * [String] healthcareProfessionalId (required):
  ///
  /// * [MultipartFile] file (required):
  Future<Response> importPatientsFromCsvWithHttpInfo(
    String institutionId,
    String healthcareProfessionalId,
    MultipartFile file,
  ) async {
    // ignore: prefer_const_declarations
    final path =
        r'/users/INSTITUTION/{institutionId}/HEALTHCARE_PROFESSIONAL/{healthcareProfessionalId}/PATIENTS/import'
            .replaceAll('{institutionId}', institutionId)
            .replaceAll('{healthcareProfessionalId}', healthcareProfessionalId);
  ...
  Future<ImportSummaryDTO?> importPatientsFromCsv(
    ...
    final response = await importPatientsFromCsvWithHttpInfo(
      institutionId,
      healthcareProfessionalId,
      file,
    );
