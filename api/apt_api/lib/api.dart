...
part 'api/datahub_controller_api.dart';
...
part 'api/widget_controller_api.dart';
...
part 'model/activity_context.dart';
...
part 'model/datahub_request_data_dto.dart';
part 'model/datahub_response.dart';
part 'model/datahub_response_recommendations_inner.dart';
...
part 'model/generic_weather.dart';
...
part 'model/heat_tolerance.dart';
part 'model/hide_activity_post_dto.dart';
part 'model/import_summary_dto.dart';
...
part 'model/message_restriction.dart';
...
part 'model/mobility_preference.dart';
...
part 'model/p2_r_coach_post_dto.dart';
part 'model/p2_r_patient_post_dto.dart';
...
part 'model/predefined_activity_post_dto.dart';
part 'model/predefined_activity_type.dart';
part 'model/prepared_report_dto.dart';
part 'model/recommendation_level.dart';
part 'model/recommendation_type.dart';
part 'model/recoomendation_reason.dart';
part 'model/refresh_token_dto.dart';
part 'model/report_post_dto.dart';
part 'model/reset_password_dto.dart';
part 'model/route_proposal.dart';
part 'model/routing_mode.dart';
part 'model/share_activity_data_post_dto.dart';
part 'model/social_message_post_dto.dart';
part 'model/space_time_recommendation_change_type.dart';
...
part 'model/token_request_dto.dart';
...
part 'model/weather_warning.dart';
part 'model/weather_warning_level.dart';
part 'model/weather_warning_type.dart';
