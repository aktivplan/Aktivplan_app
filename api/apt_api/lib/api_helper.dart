...
String parameterToString(dynamic value) {
  ...
  if (value is ActiveMinutesType) {
    return ActiveMinutesTypeTypeTransformer().encode(value).toString();
  }
  if (value is ActivityRepeat) {
    return ActivityRepeatTypeTransformer().encode(value).toString();
  }
  if (value is ActivityType) {
    return ActivityTypeTypeTransformer().encode(value).toString();
  }
  if (value is ConsentErrorCause) {
    return ConsentErrorCauseTypeTransformer().encode(value).toString();
  }
  if (value is ConsentType) {
    return ConsentTypeTypeTransformer().encode(value).toString();
  }
  if (value is DayOfWeek) {
    return DayOfWeekTypeTransformer().encode(value).toString();
  }
  if (value is ExerciseType) {
    return ExerciseTypeTypeTransformer().encode(value).toString();
  }
  if (value is ExportPatientIdentificator) {
    return ExportPatientIdentificatorTypeTransformer().encode(value).toString();
  }
  if (value is ExportSignOption) {
    return ExportSignOptionTypeTransformer().encode(value).toString();
  }
  ...
  if (value is StrengtheningExerciseMuscleGroup) {
    return StrengtheningExerciseMuscleGroupTypeTransformer()
        .encode(value)
        .toString();
  }
  if (value is TranslationLanguage) {
    return TranslationLanguageTypeTransformer().encode(value).toString();
  }
