...
class StrengtheningExercisePostDTO {
  /// Returns a new [StrengtheningExercisePostDTO] instance.
  ...
  /// when true exerciseRepeatCount is used for calculating duration, otherwise exerciseDurationSeconds
  ///
  /// Please note: This property should have been non-nullable! Since the specification file
  /// does not include a default value (using the "default:" property), however, the generated
  /// source code must fall back to having a nullable type.
  ...
  bool operator ==(Object other) =>
      ...
      other is StrengtheningExercisePostDTO &&
  ...
  /// Returns a new [StrengtheningExercisePostDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static StrengtheningExercisePostDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "StrengtheningExercisePostDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "StrengtheningExercisePostDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<StrengtheningExercisePostDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <StrengtheningExercisePostDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = StrengtheningExercisePostDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, StrengtheningExercisePostDTO> mapFromJson(dynamic json) {
    final map = <String, StrengtheningExercisePostDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = StrengtheningExercisePostDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of StrengtheningExercisePostDTO-objects as value to a dart map
  static Map<String, List<StrengtheningExercisePostDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<StrengtheningExercisePostDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = StrengtheningExercisePostDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
