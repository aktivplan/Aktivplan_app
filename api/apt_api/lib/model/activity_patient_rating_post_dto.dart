...
class ActivityPatientRatingPostDTO {
  /// Returns a new [ActivityPatientRatingPostDTO] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is ActivityPatientRatingPostDTO &&
          ...
          other.routeProposal == routeProposal;
  ...
  int get hashCode =>
      ...
      (routeProposal == null ? 0 : routeProposal!.hashCode);

  @override
  String toString() =>
      'ActivityPatientRatingPostDTO[intensityPercentage=$intensityPercentage, heartrate=$heartrate, durationMinutes=$durationMinutes, done=$done, note=$note, rating=$rating, pesiRating=$pesiRating, date=$date, time=$time, endTime=$endTime, startLocation=$startLocation, startLocationAddress=$startLocationAddress, endLocation=$endLocation, endLocationAddress=$endLocationAddress, routeProposal=$routeProposal]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.routeProposal != null) {
      json[r'routeProposal'] = this.routeProposal;
    } else {
      json[r'routeProposal'] = null;
    }
    return json;
  }

  /// Returns a new [ActivityPatientRatingPostDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ActivityPatientRatingPostDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ActivityPatientRatingPostDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ActivityPatientRatingPostDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ActivityPatientRatingPostDTO(
        ...
        routeProposal: RouteProposal.fromJson(json[r'routeProposal']),
      );
    }
    return null;
  }

  static List<ActivityPatientRatingPostDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ActivityPatientRatingPostDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityPatientRatingPostDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ActivityPatientRatingPostDTO> mapFromJson(dynamic json) {
    final map = <String, ActivityPatientRatingPostDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ActivityPatientRatingPostDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ActivityPatientRatingPostDTO-objects as value to a dart map
  static Map<String, List<ActivityPatientRatingPostDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<ActivityPatientRatingPostDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ActivityPatientRatingPostDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
