...
class OtherExercise {
  /// Returns a new [OtherExercise] instance.
  OtherExercise({
    this.id,
    this.institutionId,
    this.importId,
  ...
  /// Returns a new [OtherExercise] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OtherExercise? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "OtherExercise[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "OtherExercise[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<OtherExercise> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <OtherExercise>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OtherExercise.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OtherExercise> mapFromJson(dynamic json) {
    final map = <String, OtherExercise>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OtherExercise.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OtherExercise-objects as value to a dart map
  static Map<String, List<OtherExercise>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<OtherExercise>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OtherExercise.listFromJson(
          entry.value,
          growable: growable,
        );
      }
