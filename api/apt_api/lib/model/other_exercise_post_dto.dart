...
class OtherExercisePostDTO {
  /// Returns a new [OtherExercisePostDTO] instance.
  ...
  @override
  String toString() =>
      'OtherExercisePostDTO[hint=$hint, name=$name, youTubeUrl=$youTubeUrl, videoFileKey=$videoFileKey, type=$type, exerciseIntensityPercentageStart=$exerciseIntensityPercentageStart, exerciseIntensityPercentageEnd=$exerciseIntensityPercentageEnd, exerciseTrainingHeartRateLowerLimit=$exerciseTrainingHeartRateLowerLimit, exerciseTrainingHeartRateUpperLimit=$exerciseTrainingHeartRateUpperLimit, exerciseDurationSeconds=$exerciseDurationSeconds]';
  ...
  /// Returns a new [OtherExercisePostDTO] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OtherExercisePostDTO? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "OtherExercisePostDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "OtherExercisePostDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<OtherExercisePostDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <OtherExercisePostDTO>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OtherExercisePostDTO.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OtherExercisePostDTO> mapFromJson(dynamic json) {
    final map = <String, OtherExercisePostDTO>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OtherExercisePostDTO.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OtherExercisePostDTO-objects as value to a dart map
  static Map<String, List<OtherExercisePostDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<OtherExercisePostDTO>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OtherExercisePostDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
