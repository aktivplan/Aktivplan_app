...
class UserRole {
  ...
  static const PATIENT = UserRole._(r'PATIENT');
  static const HEALTHCARE_PROFESSIONAL = UserRole._(r'HEALTHCARE_PROFESSIONAL');
  ...
  UserRole? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'HEALTHCARE_PROFESSIONAL':
          return UserRole.HEALTHCARE_PROFESSIONAL;
        case r'INSTITUTION_ADMINISTRATOR':
