...
class ForgotPasswordDTO {
  ...
  bool operator ==(Object other) =>
      ...
      other is ForgotPasswordDTO && other.email == email;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ForgotPasswordDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ForgotPasswordDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ForgotPasswordDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ForgotPasswordDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ForgotPasswordDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
