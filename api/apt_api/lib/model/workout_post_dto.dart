...
class WorkoutPostDTO {
  ...
  @override
  String toString() =>
      'WorkoutPostDTO[name=$name, notes=$notes, exercises=$exercises, youTubeUrl=$youTubeUrl, videoFileKey=$videoFileKey, videoWaitBetweenExercisesSeconds=$videoWaitBetweenExercisesSeconds, exerciseDurationSeconds=$exerciseDurationSeconds]';
