...
class LocationDTO {
  ...
  @override
  String toString() => 'LocationDTO[longitude=$longitude, latitude=$latitude]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "LocationDTO[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "LocationDTO[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LocationDTO> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<LocationDTO>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = LocationDTO.listFromJson(
          entry.value,
          growable: growable,
        );
      }
