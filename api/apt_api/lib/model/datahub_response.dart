...
class DatahubResponse {
  ...
  List<DatahubResponseRecommendationsInner> recommendations;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DatahubResponse &&
          other.genericWeather == genericWeather &&
  ...
  int get hashCode =>
      ...
      (genericWeather == null ? 0 : genericWeather!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.genericWeather != null) {
      json[r'generic_weather'] = this.genericWeather;
    } else {
      json[r'generic_weather'] = null;
    }
  ...
  static DatahubResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DatahubResponse(
        genericWeather: GenericWeather.fromJson(json[r'generic_weather']),
        activityContext:
            ActivityContext.listFromJson(json[r'activity_context']),
        recommendations: DatahubResponseRecommendationsInner.listFromJson(
            json[r'recommendations']),
      );
    }
    return null;
  }
