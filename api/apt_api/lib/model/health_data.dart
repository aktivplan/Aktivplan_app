...
class HealthData {
  ...
  @override
  String toString() =>
      'HealthData[id=$id, createdAt=$createdAt, patientId=$patientId, jsonValue=$jsonValue]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.jsonValue != null) {
      json[r'jsonValue'] = this.jsonValue;
    } else {
      json[r'jsonValue'] = null;
    }
    return json;
  }
  ...
  static HealthData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "HealthData[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "HealthData[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return HealthData(
        ...
        jsonValue: mapValueOfType<Object>(json, r'jsonValue'),
      );
    }
    return null;
  }

  static List<HealthData> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<HealthData>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = HealthData.listFromJson(
          entry.value,
          growable: growable,
        );
      }
