...
------------- | ------------- | -------------
[**getRecommendations**](DatahubControllerApi.md#getrecommendations) | **GET** /datahub/recommendations/{patientId} | 
[**getRecommendationsForDate**](DatahubControllerApi.md#getrecommendationsfordate) | **GET** /datahub/recommendations/{patientId}/{date} | 
...
# **getRecommendations**
> DatahubResponse getRecommendations(patientId)
...
try {
    final result = api_instance.getRecommendations(patientId);
    print(result);
} catch (e) {
    print('Exception when calling DatahubControllerApi->getRecommendations: $e\n');
}
```
...
> DatahubResponse getRecommendationsForDate(patientId, date)
...
try {
    final result = api_instance.getRecommendationsForDate(patientId, date);
    print(result);
} catch (e) {
    print('Exception when calling DatahubControllerApi->getRecommendationsForDate: $e\n');
}
```
